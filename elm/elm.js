...
var $author$project$Compile$pickValidBranches = F2(
	function (alts, state) {
				...
				return A2(
					...
					function (therest) {
						if ((((((((((x.$ === 'Branch') && (x.a.$ === 'Alternative')) && x.b.b) && (x.b.a.$ === 'Branch')) && (x.b.a.a.$ === 'Guard')) && x.b.a.b.b) && x.b.a.b.b.b) && (!x.b.a.b.b.b.b)) && x.b.b.b) && (!x.b.b.b.b)) {
							...
							var _v23 = _v18.b;
							var proc = _v23.a;
							var _v24 = A2($author$project$Eval$eval, bool, state);
							if (_v24.$ === 'Ok') {
								if (_v24.a.$ === 'Boolval') {
									if (_v24.a.a) {
										_v25$2:
						...
						if (!_v0.b.b.b.b) {
							switch (_v0.a.$) {
								case 'In':
									...
									var _v13 = _v12.b;
									var _var = _v13.a;
									var _v14 = $author$project$State$getName(chan);
									if (_v14.$ === 'Ok') {
										var chanid = _v14.a;
										var _v15 = A2($author$project$State$checkFull, state, chan);
										if (_v15.$ === 'Ok') {
											if (_v15.a) {
								...
								case 'Out':
									...
									var _v18 = _v17.b;
									var expr = _v18.a;
									var _v19 = $author$project$State$getName(chan);
									if (_v19.$ === 'Ok') {
										var chanid = _v19.a;
										var _v20 = A2($author$project$State$checkFull, state, chan);
										if (_v20.$ === 'Ok') {
											if (_v20.a) {
